...
p. Also look into the main.c file to change the location of the chroot_jail and also where the submitted files and executables can be found.
...
*. Most importantly: gradually the code will need to be changed to have the system running in a chroot jail. 
